 ...
 */
final class Version20220210091126 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE content_invoice CHANGE name_product product_name VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE content_invoice ADD name_product VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP product_name, CHANGE image_product image_product VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
