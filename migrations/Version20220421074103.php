 ...
 */
final class Version20220421074103 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE content_list_product ADD purchase_id INT NOT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_B8DD51F558FBEB9 ON content_list_product (purchase_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_B8DD51F558FBEB9 ON content_list_product');
        $this->addSql('ALTER TABLE content_list_product DROP purchase_id');
