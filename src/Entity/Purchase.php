...
class Purchase
{
    ...
    #[ORM\OneToOne(mappedBy: 'purchase', targetEntity: ContentListProduct::class, cascade: ['persist', 'remove'])]
    private $contentlistProduct;
    ...
    public function getContentListProduct(): ?ContentListProduct
    {
        return $this->contentlistProduct;
    }

    public function setContentListProduct(ContentListProduct $contentlistProduct): self
    {
        ...
        $this->contentlistProduct = $contentlistProduct;
